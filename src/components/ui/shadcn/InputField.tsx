  ...
  ({ className, type, icon, validationType, ...props }, ref) => {
    ...
    return (
      <div className="relative">
        {icon && (
          <div className="absolute end-2 top-1/2 -translate-y-1/2 text-softColor text-xl text-black bg-white w-13 h-13 rounded-full flex justify-center items-center hover:scale-95 hover:opacity-80 cursor-pointer duration-300">
            {icon}
          </div>
        )}
        <input
